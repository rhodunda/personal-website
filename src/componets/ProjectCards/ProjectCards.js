...
class  ProjectCards extends Component {
    ...
    state = [
        {name: 'The Mix', img1: TheMixPicture, img2: TheMixPicture2, img3: TheMixPicture3, description: 'The Mix is an online cocktail sharing website that allows users to create, favorite, rate, and review cocktails. After a user creates an account and login they can browse through hundreds of cocktails added to the database.', link: 'https://cocktailfrontend.herokuapp.com/'},
        ...
        {name: 'Coming Soon!!!', img1: ComingSoon, img2: ComingSoon, img3: ComingSoon, description: 'SpaceX Dashboard, please check back for updates.', link: undefined}
    ]
